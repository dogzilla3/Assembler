...
bool Sym::IsStandardFunctionSymbol(void){return symbolkind == symkind_standardfunction;}
bool Sym::IsStandardProcedureSymbol(void){return symbolkind == symkind_standardprocedure;}
bool Sym::IsProcedureSymbol(void){return symbolkind == symkind_procedure;}
bool Sym::IsFunctionSymbol(void){return symbolkind == symkind_function;}
//-----------------------------------------------------------------------------
//class TypeSymbol
//-----------------------------------------------------------------------------
...
{   fout << endl << "In Print Function" << endl;
    Sym::Print(o,indent);
    o << endl;
    for (int a=0;a<indent+1;a++) o << "  ";
