...
bool Exp::IsBoolean(){return typ->IsBoolean();}
bool Exp::IsCharacter(){return typ->IsCharacter();}
bool Exp::IsInteger(){return typ->IsInteger();}
bool Exp::IsReal(){return typ->IsReal();}
PCode* Exp::FetchPCode(void){return pCode;}
