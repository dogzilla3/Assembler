...
{
       0,   154,   154,   161,   168,   174,   181,   186,   192,   198,
     205,   212,   217,   224,   231,   238,   245,   250,   257,   264,
     271,   278,   284,   291,   298,   305,   312,   318,   325,   332,
     339,   346,   353,   360,   367,   374,   381,   388,   395,   402,
     409,   416,   423,   430,   436,   442,   448,   454,   460,   466,
     473,   480,   487,   493,   499,   505,   511,   517,   524,   531,
     537,   543,   549,   555,   561,   568,   575,   582,   589,   596,
     603,   610
};
#endif
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 155 "paspar.y" /* yacc.c:1646  */
    {fout << endl << "#01 program -> program_head program_declarations program_body";
		program((yyvsp[-2].subprog),(yyvsp[0].explist));
	}
...
#line 162 "paspar.y" /* yacc.c:1646  */
    {fout << endl << "#02 program_head -> program ID(" << (*(yyvsp[-2].token)) << ") program_parameters SEMICOLON";
		(yyval.subprog)=program_head(*(yyvsp[-2].token));
	}
#line 1489 "y.tab.c" /* yacc.c:1646  */
    break;

  case 4:
#line 169 "paspar.y" /* yacc.c:1646  */
...
#line 1496 "y.tab.c" /* yacc.c:1646  */
  ...
  case 5:
#line 175 "paspar.y" /* yacc.c:1646  */
    {fout << endl << "#04 program_body -> compound_statement PERIOD";
		(yyval.explist)=Program_body((yyvsp[-1].explist));
	}
...
#line 1525 "y.tab.c" /* yacc.c:1646  */
  ...
  case 9:
#line 199 "paspar.y" /* yacc.c:1646  */
    {fout << endl << "#08 identifier_list -> ID(" << (*(yyvsp[0].token)) << ")";	
		(yyval.strlist)=idList((yyvsp[0].token));
	}
#line 1533 "y.tab.c" /* yacc.c:1646  */
    break;

  case 10:
#line 206 "paspar.y" /* yacc.c:1646  */
    {fout << endl << "#09 identifier_list -> identifier_list , ID(" << (*(yyvsp[0].token)) << ")";
		(yyval.strlist)=idList((yyvsp[-2].strlist),(yyvsp[0].token));
	}
...
#line 1548 "y.tab.c" /* yacc.c:1646  */
  ...
  case 12:
#line 218 "paspar.y" /* yacc.c:1646  */
    {fout << endl << "#11 variable_declarations -> variable_declarations VAR identifier_list " << (*(yyvsp[-3].strlist)).PrintList() << " : type SEMICOLON";
		variable_declarations((yyvsp[-3].strlist), (yyvsp[-1].type));
	}
#line 1556 "y.tab.c" /* yacc.c:1646  */
    break;

  case 13:
#line 225 "paspar.y" /* yacc.c:1646  */
...
#line 232 "paspar.y" /* yacc.c:1646  */
    {fout << endl << "#13 type -> array [ intlit .. intlit ] of standard_type";
		(yyval.type)=type(*(yyvsp[-5].token),*(yyvsp[-3].token),(yyvsp[0].type));
	}
#line 1572 "y.tab.c" /* yacc.c:1646  */
    break;

  case 15:
#line 239 "paspar.y" /* yacc.c:1646  */
    {fout << endl << "#14 standard_type -> ID(" << (*(yyvsp[0].token)) << ")";
		(yyval.type)=standard_type(*(yyvsp[0].token));
	}
#line 1580 "y.tab.c" /* yacc.c:1646  */
    break;

  case 16:
#line 245 "paspar.y" /* yacc.c:1646  */
...
#line 1595 "y.tab.c" /* yacc.c:1646  */
  ...
  case 18:
#line 258 "paspar.y" /* yacc.c:1646  */
    {fout << endl << "#17 subprogram_declarations -> subprogram_head declarations compound_statement";
		subprogram_declaration((yyvsp[-2].subprog),(yyvsp[0].explist));
	}
#line 1603 "y.tab.c" /* yacc.c:1646  */
    break;

  case 19:
#line 265 "paspar.y" /* yacc.c:1646  */
    {fout << endl << "#18 subprogram_head -> function ID(" << (*(yyvsp[-4].token)) << ") subprogram_parameters : standard_type ;";
		(yyval.subprog)=subprogram_head(*(yyvsp[-4].token),(yyvsp[-3].varlist),(yyvsp[-1].type));
	}
...
#line 272 "paspar.y" /* yacc.c:1646  */
    {fout << endl << "#19 subprogram_head -> procedure ID(" << (*(yyvsp[-2].token)) << ") subprogram_parameters ;";
		(yyval.subprog)=subprogram_head(*(yyvsp[-2].token),(yyvsp[-1].varlist));
	}
#line 1619 "y.tab.c" /* yacc.c:1646  */
    break;

  case 21:
#line 278 "paspar.y" /* yacc.c:1646  */
...
#line 1627 "y.tab.c" /* yacc.c:1646  */
  ...
  case 22:
#line 285 "paspar.y" /* yacc.c:1646  */
    {fout << endl << "#21 subprogram_parameters -> ( parameter_list )";
		(yyval.varlist)=subprogram_parameters((yyvsp[-1].varlist));
	}
...
#line 292 "paspar.y" /* yacc.c:1646  */
    {fout << endl << "#22 parameter_list -> identifier_list : type";
		(yyval.varlist)=parameter_list((yyvsp[-2].strlist), (yyvsp[0].type));
	}
#line 1643 "y.tab.c" /* yacc.c:1646  */
    break;

  case 24:
#line 299 "paspar.y" /* yacc.c:1646  */
    {fout << endl << "#23 parameter_list -> parameter_list ; identifier_list : type";
		(yyval.varlist)=parameter_list((yyvsp[-4].varlist), (yyvsp[-2].strlist), (yyvsp[0].type));
	}
#line 1651 "y.tab.c" /* yacc.c:1646  */
    break;

  case 25:
#line 306 "paspar.y" /* yacc.c:1646  */
    {fout << endl << "#24 compound_statement -> BEGIN optional_statements END";
		(yyval.explist)=Compound_statement((yyvsp[-1].explist));	
	}
...
#line 1667 "y.tab.c" /* yacc.c:1646  */
  ...
  case 27:
#line 319 "paspar.y" /* yacc.c:1646  */
    {fout << endl << "#26 optional_statements -> statement_list";
		(yyval.explist)=Optional_statements((yyvsp[0].explist));
	}
#line 1675 "y.tab.c" /* yacc.c:1646  */
    break;

  case 28:
#line 326 "paspar.y" /* yacc.c:1646  */
    {fout << endl << "#27 statement_list -> statement";
		(yyval.explist)=Statement_list((yyvsp[0].explist));
	}
#line 1683 "y.tab.c" /* yacc.c:1646  */
    break;

  case 29:
#line 333 "paspar.y" /* yacc.c:1646  */
    {fout << endl << "#28 statement_list -> statement_list SEMICOLON statement";
		(yyval.explist)=Statement_list((yyvsp[-2].explist),(yyvsp[0].explist));
	}
...
#line 340 "paspar.y" /* yacc.c:1646  */
    {fout << endl << "#29 statement -> variable := expression";
		(yyval.explist)=statement((yyvsp[-2].exp),(yyvsp[0].exp));
	}
#line 1699 "y.tab.c" /* yacc.c:1646  */
    break;

  case 31:
#line 347 "paspar.y" /* yacc.c:1646  */
    {fout << endl << "#30 statement -> procedure_statement";
		(yyval.explist)=statement((yyvsp[0].exp));
	}
#line 1707 "y.tab.c" /* yacc.c:1646  */
    break;

  case 32:
#line 354 "paspar.y" /* yacc.c:1646  */
    {fout << endl << "#31 statement -> compound_statement";
		(yyval.explist)=statement((yyvsp[0].explist));
	}
#line 1715 "y.tab.c" /* yacc.c:1646  */
    break;

  case 33:
#line 361 "paspar.y" /* yacc.c:1646  */
    {fout << endl << "#32 statement -> if expression then statement else statement";
		(yyval.explist)=statement((yyvsp[-4].exp),(yyvsp[-2].explist),(yyvsp[0].explist));
	}
...
#line 368 "paspar.y" /* yacc.c:1646  */
    {fout << endl << "#33 statement -> while expression do statement";
		(yyval.explist)=statement((yyvsp[-2].exp),(yyvsp[0].explist));
	}
#line 1731 "y.tab.c" /* yacc.c:1646  */
    break;

  case 35:
#line 375 "paspar.y" /* yacc.c:1646  */
    {fout << endl << "#34 variable -> ID(" << (*(yyvsp[0].token)) << ")";
		(yyval.exp)=variable((yyvsp[0].token));
	}
#line 1739 "y.tab.c" /* yacc.c:1646  */
    break;

  case 36:
#line 382 "paspar.y" /* yacc.c:1646  */
    {fout << endl << "#35 variable -> ID(" << (*(yyvsp[-3].token)) << ") LPAREN expression RPAREN";
		(yyval.exp)=variable((yyvsp[-3].token), (yyvsp[-1].exp));
	}
#line 1747 "y.tab.c" /* yacc.c:1646  */
    break;

  case 37:
#line 389 "paspar.y" /* yacc.c:1646  */
    {fout << endl << "#36 procedure_statement -> ID(" << (*(yyvsp[0].token)) << ")";
		(yyval.exp)=procedure_statement((yyvsp[0].token));
	}
#line 1755 "y.tab.c" /* yacc.c:1646  */
    break;

  case 38:
#line 396 "paspar.y" /* yacc.c:1646  */
    {fout << endl << "#37 ID(" << (*(yyvsp[-3].token)) << ") ( expression_list )";
		(yyval.exp)=procedure_statement((yyvsp[-3].token), (yyvsp[-1].explist));
	}
#line 1763 "y.tab.c" /* yacc.c:1646  */
    break;

  case 39:
#line 403 "paspar.y" /* yacc.c:1646  */
    {fout << endl << "#38 expression_list -> expression";
		(yyval.explist)=expression_list((yyvsp[0].exp));
	}
#line 1771 "y.tab.c" /* yacc.c:1646  */
    break;

  case 40:
#line 410 "paspar.y" /* yacc.c:1646  */
    {fout << endl << "#39 expression_list -> expression_list , expression";
		(yyval.explist)=expression_list((yyvsp[-2].explist),(yyvsp[0].exp));
	}
#line 1779 "y.tab.c" /* yacc.c:1646  */
    break;

  case 41:
#line 417 "paspar.y" /* yacc.c:1646  */
...
#line 1787 "y.tab.c" /* yacc.c:1646  */
  ...
  case 42:
#line 424 "paspar.y" /* yacc.c:1646  */
    {fout << endl << "#41 expression -> simple_expression relop simple_expression";
		(yyval.exp)=expression((yyvsp[-2].exp),(yyvsp[-1].token),(yyvsp[0].exp));
	}
#line 1795 "y.tab.c" /* yacc.c:1646  */
    break;

  case 43:
#line 431 "paspar.y" /* yacc.c:1646  */
    {fout << endl << "#42 relop -> =";
	}
...
#line 1837 "y.tab.c" /* yacc.c:1646  */
  ...
  case 49:
#line 467 "paspar.y" /* yacc.c:1646  */
    {fout << endl << "#48 simple_expression -> term";
		(yyval.exp)=simple_expression((yyvsp[0].exp));
	}
#line 1845 "y.tab.c" /* yacc.c:1646  */
    break;

  case 50:
#line 474 "paspar.y" /* yacc.c:1646  */
    {fout << endl << "#49 simple_expression -> sign term";
		(yyval.exp)=simple_expression((yyvsp[-1].token), (yyvsp[0].exp));
	}
#line 1853 "y.tab.c" /* yacc.c:1646  */
    break;

  case 51:
#line 481 "paspar.y" /* yacc.c:1646  */
    {fout << endl << "#50 simple_expression -> simple_expression addop term";
		(yyval.exp)=simple_expression((yyvsp[-2].exp), (yyvsp[-1].token), (yyvsp[0].exp));
	}
#line 1861 "y.tab.c" /* yacc.c:1646  */
    break;

  case 52:
#line 488 "paspar.y" /* yacc.c:1646  */
    {fout << endl << "#51 sign -> +";
	}
...
#line 1896 "y.tab.c" /* yacc.c:1646  */
  ...
  case 57:
#line 518 "paspar.y" /* yacc.c:1646  */
    {fout << endl << "#56 term -> factor";
		(yyval.exp)=term((yyvsp[0].exp));
	}
#line 1904 "y.tab.c" /* yacc.c:1646  */
    break;

  case 58:
#line 525 "paspar.y" /* yacc.c:1646  */
    {fout << endl << "#57 term -> term mulop factor";
		(yyval.exp)=term((yyvsp[-2].exp), (yyvsp[-1].token), (yyvsp[0].exp));
	}
#line 1912 "y.tab.c" /* yacc.c:1646  */
    break;

  case 59:
#line 532 "paspar.y" /* yacc.c:1646  */
    {fout << endl << "#58 mulop -> *";
	}
...
#line 1947 "y.tab.c" /* yacc.c:1646  */
  ...
  case 64:
#line 562 "paspar.y" /* yacc.c:1646  */
    {fout << endl << "#63 factor -> ID(" << (*(yyvsp[0].token)) << ")";
		(yyval.exp) = factor_1((yyvsp[0].token));
	}
#line 1955 "y.tab.c" /* yacc.c:1646  */
    break;

  case 65:
#line 569 "paspar.y" /* yacc.c:1646  */
    {fout << endl << "#64 factor -> ID(" << (*(yyvsp[-3].token)) << ") RBRACKET expression RBRACKET";
		(yyval.exp)=factor_2((yyvsp[-3].token), (yyvsp[-1].exp));
	}
#line 1963 "y.tab.c" /* yacc.c:1646  */
    break;

  case 66:
#line 576 "paspar.y" /* yacc.c:1646  */
    {fout << endl << "#65 factor -> ID(" << (*(yyvsp[-3].token)) << ") LPAREN expression_list RPAREN";
		(yyval.exp) = factor_3((yyvsp[-3].token), (yyvsp[-1].explist));
	}
#line 1971 "y.tab.c" /* yacc.c:1646  */
    break;

  case 67:
#line 583 "paspar.y" /* yacc.c:1646  */
    {fout << endl << "#66 mulop -> LPAREN expression RPAREN";
		(yyval.exp) = factor_4((yyvsp[-1].exp));
	}
#line 1979 "y.tab.c" /* yacc.c:1646  */
    break;

  case 68:
#line 590 "paspar.y" /* yacc.c:1646  */
    {fout << endl << "#67 mulop -> NOT factor";
		(yyval.exp) = factor_5((yyvsp[0].exp));
	}
#line 1987 "y.tab.c" /* yacc.c:1646  */
    break;

  case 69:
#line 597 "paspar.y" /* yacc.c:1646  */
    {fout << endl << "#68 factor -> INTLIT(" << (*(yyvsp[0].token)) << ")";
		(yyval.exp) = factor_6((yyvsp[0].token));
	}
#line 1995 "y.tab.c" /* yacc.c:1646  */
    break;

  case 70:
#line 604 "paspar.y" /* yacc.c:1646  */
    {fout << endl << "#69 factor -> REALIT(" << (*(yyvsp[0].token)) << ")";
		(yyval.exp) = factor_7((yyvsp[0].token));
	}
#line 2003 "y.tab.c" /* yacc.c:1646  */
    break;

  case 71:
#line 611 "paspar.y" /* yacc.c:1646  */
    {fout << endl << "#70 factor -> CHRLIT(" << (*(yyvsp[0].token)) << ")";
		(yyval.exp) = factor_8((yyvsp[0].token));
	}
